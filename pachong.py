...
class crawler(object):
    ssl._create_default_https_context = ssl._create_unverified_context  # 问题1，问题2是动态
    ...
    def getdata(self):
        ...
        findinfo = re.compile(r'<div class="rank_d_b_info">(.*?)</div>', re.S)  # 问题4
        findimg = re.compile(r'src="(.*?)"/>')  # 问题5
        ...
        for i in range(1, 4):
            ...
            for item in soup.find_all('div', class_="rank_d_list borderB_c_dsh clearfix"):
                ...
                authorlink = re.findall(findLink, item)[2]  # 问题3
